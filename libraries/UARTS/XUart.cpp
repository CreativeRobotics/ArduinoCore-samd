...
XUart::XUart(SERCOM *_s, uint8_t _pinRX, uint8_t _pinTX, SercomRXPad _padRX, SercomUartTXPad _padTX) :
  XUart(_s, _pinRX, _pinTX, _padRX, _padTX, NO_RTS_PIN, NO_CTS_PIN)
{
}

XUart::XUart(SERCOM *_s, uint8_t _pinRX, uint8_t _pinTX, SercomRXPad _padRX, SercomUartTXPad _padTX, uint8_t _pinRTS, uint8_t _pinCTS)
{
  sercom = _s;
  uc_pinRX = _pinRX;
  uc_pinTX = _pinTX;
...
void XUart::begin(unsigned long baudrate)
{
  begin(baudrate, SERIAL_8N1);
}

void XUart::begin(unsigned long baudrate, uint16_t config)
{
...
size_t XUart::write(const uint8_t data)
{
...
SercomNumberStopBit XUart::extractNbStopBit(uint16_t config)
{
...
SercomUartCharSize XUart::extractCharSize(uint16_t config)
{
...
SercomParityMode XUart::extractParity(uint16_t config)
{
