...
void SamRTC::begin(bool resetTime)
{
  uint16_t tmp_reg = 0;
...
void SamRTC::enableAlarm(Alarm_Match match)
{
  if (_configured) {
...
void SamRTC::attachInterrupt(voidFuncPtr callback)
{
  RTC_callBack = callback;
}

void SamRTC::detachInterrupt()
{
  RTC_callBack = NULL;
}

void SamRTC::standbyMode()
{
...
void SamRTC::setSeconds(uint8_t seconds)
{
  if (_configured) {
...
void SamRTC::setMinutes(uint8_t minutes)
{
  if (_configured) {
...
void SamRTC::setHours(uint8_t hours)
{
  if (_configured) {
...
void SamRTC::setTime(uint8_t hours, uint8_t minutes, uint8_t seconds)
{
  if (_configured) {
    setSeconds(seconds);
    setMinutes(minutes);
...
void SamRTC::setDay(uint8_t day)
{
  if (_configured) {
...
void SamRTC::setMonth(uint8_t month)
{
  if (_configured) {
...
void SamRTC::setYear(uint8_t year)
{
  if (_configured) {
...
void SamRTC::setDate(uint8_t day, uint8_t month, uint8_t year)
{
  if (_configured) {
    setDay(day);
    setMonth(month);
...
void SamRTC::setAlarmSeconds(uint8_t seconds)
{
  if (_configured) {
...
void SamRTC::setAlarmMinutes(uint8_t minutes)
{
  if (_configured) {
...
void SamRTC::setAlarmHours(uint8_t hours)
{
  if (_configured) {
...
void SamRTC::setAlarmTime(uint8_t hours, uint8_t minutes, uint8_t seconds)
{
  if (_configured) {
...
void SamRTC::setAlarmDay(uint8_t day)
{
  if (_configured) {
...
void SamRTC::setAlarmMonth(uint8_t month)
{
  if (_configured) {
...
void SamRTC::setAlarmYear(uint8_t year)
{
  if (_configured) {
...
void SamRTC::setAlarmDate(uint8_t day, uint8_t month, uint8_t year)
{
  if (_configured) {
    setAlarmDay(day);
    setAlarmMonth(month);
...
uint32_t SamRTC::getY2kEpoch()
{
  return (getEpoch() - EPOCH_TIME_OFF);
}

void SamRTC::setAlarmEpoch(uint32_t ts)
{
  if (_configured) {
...
void SamRTC::setEpoch(uint32_t ts)
{
  if (_configured) {
    if (ts < EPOCH_TIME_OFF) {
      ts = EPOCH_TIME_OFF;
...
void SamRTC::setY2kEpoch(uint32_t ts)
{
  if (_configured) {
...
inline void SamRTC::RTCreadRequest() {
	if (_configured) {
...
inline bool SamRTC::RTCisSyncing()
{
#if defined(__SAMD51__)
